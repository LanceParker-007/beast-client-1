...
var ASM_CONSTS = {
  4064400: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4064461: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4064525: function() {return Module.webglContextAttributes.powerPreference;},  
 4064583: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4064638: function($0) {performance.now = function() { return $0; };},  
 4064686: function($0) {performance.now = function() { return $0; };},  
 4064734: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _SendLobbyCodeToReact(LobbyCode) {
      window.dispatchReactUnityEvent(
        "SendLobbyCodeToReact",
        UTF8ToString(LobbyCode)
      );
    }

  function _SendUserIdToReact(userId) {
...
var asmLibraryArg = {
  ...
  "SendLobbyCodeToReact": _SendLobbyCodeToReact,
  "SendUserIdToReact": _SendUserIdToReact,
