...
const TermsAndConditions = () => {
  return (
    <Box padding={"2vh 6vw"}>
      <p>Welcome to PlayBrutal!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of PlayBrutal's Website, located at playbrutal.in.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use PlayBrutal if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing PlayBrutal, you agreed to use
        cookies in agreement with the PlayBrutal's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, PlayBrutal and/or its licensors own the
        intellectual property rights for all material on PlayBrutal. All
        intellectual property rights are reserved. You may access this from
        PlayBrutal for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from PlayBrutal</li>
        <li>Sell, rent or sub-license material from PlayBrutal</li>
        <li>Reproduce, duplicate or copy material from PlayBrutal</li>
        <li>Redistribute content from PlayBrutal</li>
      </ul>
      ...
      <p>
        ...
        PlayBrutal does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of PlayBrutal,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, PlayBrutal shall not be
      ...
      <p>
        PlayBrutal reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant PlayBrutal a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of PlayBrutal; and (d) the link is
      ...
      <p>
        ...
        e-mail to PlayBrutal. Please include your name, your organization name,
      ...
      <p>
        No use of PlayBrutal's logo or other artwork will be allowed for linking
