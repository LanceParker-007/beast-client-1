...
const Privacy = () => {
  return (
    <Box padding={"2vh 6vw"}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to playbrutal.in.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to playbrutal.in, accessible from{" "}
            <Link
              to="playbrutal.in"
      ...
      <ul>
        <li>
          <p>By email: contactplaybrutal@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <Link
              to="playbrutal.in/contact-us"
              rel="external nofollow noopener"
              target="_blank"
            >
              playbrutal.in/contact-us
            </Link>
          </p>
        </li>
      </ul>
